...
describe('share-socket', function () {
    ...
    beforeEach(function (done) {
        ...
        originalGlobalAgent = index_1.globalAgent;
        server.listen(port, () => {
            if (!(server._sock instanceof dgram_1.Socket)) {
                return;
            }
            const sock = server._sock;
            (0, index_1.setGlobalAgent)(new index_1.Agent({
                socket: sock
            }));
            done();
        });
    ...
    afterEach(function (done) {
        ...
        (0, index_1.setGlobalAgent)(originalGlobalAgent);
    });
    ...
    it('should error after ~247 seconds', function (done) {
        ...
        const req = (0, index_1.request)(`coap://localhost:${port + 1}`);
        req.end();
...
//# sourceMappingURL=share-socket.js.map